...
cd /etc/kolla/Logos/
docker cp bitslogo-splash.svg horizon:/var/lib/kolla/venv/lib/python3.9/site-packages/static/dashboard/img
docker cp bitslogo.svg horizon:/var/lib/kolla/venv/lib/python3.9/site-packages/static/dashboard/img
